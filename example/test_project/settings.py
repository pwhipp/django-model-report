...
DATABASES = {
    'default': {
        ...
        'NAME': join(PROJECT_ABSOLUTE_DIR, 'model_report.sqlite3')}}
...
STATIC_ROOT = PROJECT_ABSOLUTE_DIR + '/static_collected/'
...
STATICFILES_DIRS = [join(PROJECT_ABSOLUTE_DIR, 'static')]
...
ROOT_URLCONF = 'example.test_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'example.test_project.wsgi.application'
